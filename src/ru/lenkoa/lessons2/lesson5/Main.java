...
public class Main {
    ...
    public void countA(){
        ...
        IntStream.range(0, arr.length).forEach(i -> arr[i] = (float)(arr[i] * Math.sin(0.2f + i / 5) * Math.cos(0.2f + i / 5) * Math.cos(0.4f + i / 2)));
